During the course, we developed a method to segment crop fields from the satellite images and then evaluated the result amages with the gorund truth images. 
